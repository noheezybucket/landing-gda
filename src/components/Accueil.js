...
const Accueil = () => {
  return (
    <div>
      ...
      <main className="">
        <section
          className="outline flex h-auto bg-no-repeat bg-cover bg-bottom md:px-10 px-5"
          style={{ backgroundImage: `url(${wave})` }}
        >
          <div className="uppercase  w-7/12">
            <h1 className="font-bold md:text-4xl text-2xl w-11/12 leading-normal md:-mt-14 md:mb-6 mb-3">
              Soigner l'image des <br />
              entreprises sénégalaises sur
              <br className="hidden" /> le web
            </h1>
            <p className="text-xs mb-3 w-full md:mb-12 md:text-2xl">
              NOUS AIDONS votre ENTREPRISE À ACQUÉRIR UNE MEILLEURE VISIBILITÉ
              ET À SOIGNER SA COMMUNICATION SUR interNET
              <br className="hidden" /> grace à un site web moderne adapté à
              votre cible.
            </p>
          ...
          <div className="relative top-10 md:bottom-10 sm:bottom-8 sm:left-10 h-fit">
        ...
        <section className="bg-gradient-to-b from-gradient1 to-gradient2 h-auto md:px-10 px-5 pt-20">
          <div className="flex justify-between flex-col md:flex-row gap-y-4">
            <div className="flex h-fit">
              ...
              <h2 className="font-second font-bold text-xl text-white md:text-4xl h-fit">
                GALSEN DIGITAL
                <br /> AGENCY
              </h2>
            </div>
            <div className="flex flex-col">
              <h2 className="font-first text-3xl md:text-right text-center text-white leading-tight md:text-6xl">
                L’ AGENCE DIGITALE CRÉATIVE
                <br /> ET CENTRÉE CLIENT
              </h2>
              <span className="md:w-48 w-20 h-1 bg-barre mt-2 p-0.5 hidden md:self-end md:block"></span>
            </div>
          </div>

          <div className="flex flex-col gap-y-5 md:flex-row md:justify-between items-center mt-7 md:mt-20">
            <div className="max-w-maxwidth md:max-w-xl relative">
              <img
                src={homme}
                alt="old man struggling with his computer"
                className=""
              />
              {/* <div className="absolute w-full bg-gradient-to-t from-gradient3 via-gradient-4 to-gradient-5 h-[10vh]  bottom-0"></div> */}
              <p className="w-full md:text-4xl text-2xl font-bold absolute bottom-0 text-white text-center mb-10">
            ...
            <div className="max-w-maxwidth md:max-w-xl relative">
              ...
              {/* <div className="absolute w-full bg-gradient-to-t from-gradient3 via-gradient6 to-gradient7 h-[10vh]  bottom-0"></div> */}
              <p className="w-full md:text-4xl text-2xl font-bold absolute bottom-0 text-white text-center mb-10">
        ...
        <section className="pt-20 flex items-center justify-center">
          <img
            src={dotted}
            alt="dotted-line"
            className="relative top-14 hidden md:block"
          />
          <h2 className="font-second text-gradient3 text-3xl md:text-5xl text-center px-5">
            IL VOUS PERMETTRA EGALEMENT
          </h2>
          <img
            src={dotted2}
            alt="dotted line"
            className="relative bottom-16 hidden md:block"
          />
        </section>

        <section className="flex flex-col sm:flex-row justify-between items-center gap-y-5 px-10 mt-16  pb-20">
          <div className="bg-primary text-white max-w-maxwidth p-5 rounded-xl drop-shadow-2xl">
            <div className="flex items-center">
          ...
          <div className="bg-primary text-white max-w-maxwidth p-5 rounded-xl">
            <div className="flex items-center">
              <h3 className="md:text-lg text-md uppercase md:pb-7 pb-3">
        ...
        <section className="px-10 mb-20">
          <div className="flex mb-10">
            ...
            <h2 className="font-second font-bold md:text-5xl text-4xl text-gradient3">
              ILS NOUS ONT FAIT CONFIANCE
              <br className="hidden md:block" /> ET NE L’ONT PAS REGRETTÉ !
            </h2>
          </div>
          <p className="md:text-3xl text-md bg-primary md:p-10 p-5 md:mb-7 mb-3 rounded-xl text-white text-center font-third">
        ...
        <section className="flex flex-col items-center bg-gradient3 text-white md:px-10 px-5 md:py-14 py-7">
          ...
          <div className="flex justify-evenly w-full">
            <div className="">
              <div className="flex flex-col items-center">
                ...
                <h3 className="md:text-xl text-xs font-bold border-b-4 border-tertiary mb-8">
                  GRAPHISME
                </h3>
                <p className="text-sm font-third text-center">
            ...
            <div className="">
              <div className="flex flex-col items-center">
                ...
                <h3 className="md:text-xl text-xs font-bold text-center border-b-4 border-tertiary mb-8">
                  COMMUNITY MANAGEMENT
                </h3>
                <p className="text-sm font-third uppercase text-center max-w-xs">
            ...
            <div className="">
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm font-third text-center uppercase max-w-xs">
